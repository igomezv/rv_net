...
class Ridge_regress_harps(object):

  def __init__(self, TRAIN_FILE_NAME_LIST, VAL_FILE_NAME_LIST, alpha, verbose):
    self.TRAIN_FILE_NAME_LIST = TRAIN_FILE_NAME_LIST
    self.VAL_FILE_NAME_LIST = VAL_FILE_NAME_LIST
    self.alpha = alpha
